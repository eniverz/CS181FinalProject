...
export default () => {
    ...
    return (
        <div className="w-screen h-screen overflow-hidden flex justify-center items-center">
            <div className="flex flex-col relative items-center h-1/2 w-1/4 bg-zinc-50/10 backdrop-blur-md rounded-xl border">
                <div className="text-center text-6xl bg-clip-text bg-gradient-to-r from-pink-300 to-violet-300 text-transparent font-extrabold mt-12">
                    Chinese Checker
                </div>
                <div className="space-y-5 -mt-16 flex flex-col justify-center items-center w-full h-full">
